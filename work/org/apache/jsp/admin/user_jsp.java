 ...
 * Generated at: 2012-10-15 12:53:22 UTC
...
static {
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t$(function() {\r\n");
      out.write("\t\t\t\t\t\t$(\"#user_add_form\").validate({\r\n");
      out.write("\t\t\t\t\t\t\trules : {\r\n");
      out.write("\t\t\t\t\t\t\t\tuserName : {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\tt = new SimpleTable(\"userQueryTable\", {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\thtml += '&nbsp;&nbsp;<a href=\"javascript:changePassword(' + obj.id + ');\">密码重置</a>';\r\n");
      ...
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t$('#user_add_form_div').dialog({\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tajaxSubmitForm(\"user_add_form\", editCallback);\r\n");
      out.write("\t\t\t\t\t\t\t\t},\r\n");
      ...
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t$('#user_edit_form_div').dialog({\r\n");
      out.write("\t\t\t\t\t\t\tdraggable : true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\tbuttons : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\"OK\" : function() {\r\n");
      out.write("\t\t\t\t\t\t\t\t\tajaxSubmitForm(\"user_edit_form\", editCallback);\r\n");
      out.write("\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\"Cancel\" : function() {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t$(this).dialog(\"close\");\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t$('#change_password_form_div').dialog({\r\n");
      out.write("\t\t\t\t\t\t\tdraggable : true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\tbuttons : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\"OK\" : function() {\r\n");
      out.write("\t\t\t\t\t\t\t\t\tajaxSubmitForm(\"change_password_form\");\r\n");
      out.write("\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\"Cancel\" : function() {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t$(this).dialog(\"close\");\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\t\tdoGetAjax(\"");
      out.print(request.getContextPath());
      out.write("/admin/user/\" + id + \".html\", '', function(data, textStatus, XMLHttpRequest) {\r\n");
      out.write("\t\t\t\t\t\t\tdocument.forms['user_edit_form'].reset();\r\n");
      out.write("\t\t\t\t\t\t\tfillForm(\"user_edit_form\", data);\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#user_edit_form_div\").dialog(\"open\");\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\tfunction changePassword(id) {\r\n");
      out.write("\t\t\t\t\t\tdocument.forms['change_password_form'].reset();\r\n");
      out.write("\t\t\t\t\t\tfillForm(\"change_password_form\", {\r\n");
      out.write("\t\t\t\t\t\t\tid : id\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t$(\"#change_password_form_div\").dialog(\"open\");\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t</script>\r\n");
      ...
      out.write("\t\t\t\t\t\t\tdocument.forms['user_add_form'].reset();\r\n");
      out.write("\t\t\t\t\t\t\t$('#user_add_form_div').dialog(\"open\");\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t</script>\r\n");
      out.write("\t\t\t\t\t<a href=\"javascript:showAddForm();\">添加新用户</a>\r\n");
      out.write("\t\t\t\t\t<br />\r\n");
      out.write("\t\t\t\t\t<br/>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div id=\"user_add_form_div\" style=\"display: none;\">\r\n");
      out.write("\t\t\t\t<form id=\"user_add_form\" action=\"");
      out.print(request.getContextPath());
      out.write("/admin/user_edit.ajax\"  method=\"post\">\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" style=\"display: none;\" name=\"id\" />\r\n");
      out.write("\t\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>用户名称：</td><td>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"userName\" />\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>角色：</td><td><select name=\"roleId\" class=\"ajaxSelect\" autoLoad=\"true\"\r\n");
      out.write("\t\t\t\t\t\t\tajaxUrl=\"");
      out.print(request.getContextPath());
      out.write("/admin/user/role_list.ajax\" dataRoot=\"roles\"\r\n");
      out.write("\t\t\t\t\t\t\tvalueField=\"id\" displayField=\"name\"></select></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>密码：</td><td>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"password\" id=\"f_password1\" name=\"password1\" />\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>密码确认：</td><td>\r\n");
      ...
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div id=\"user_edit_form_div\" style=\"display: none;\">\r\n");
      out.write("\t\t\t\t<form id=\"user_edit_form\" action=\"");
      out.print(request.getContextPath());
      out.write("/admin/user_edit.ajax\"  method=\"post\">\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" style=\"display: none;\" name=\"id\" />\r\n");
      out.write("\t\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>用户名称：</td><td>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"userName\" readonly=\"readonly\" />\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>角色：</td><td><select name=\"roleId\" class=\"ajaxSelect\" autoLoad=\"true\"\r\n");
      out.write("\t\t\t\t\t\t\tajaxUrl=\"");
      out.print(request.getContextPath());
      ...
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>是否禁用：</td><td colspan=\"3\">\r\n");
      out.write("\t\t\t\t\t\t\t<input id=\"disabled_true_edit\" type=\"radio\" name=\"disabled\" value=\"true\" />\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"disabled_true_edit\">禁用</label>\r\n");
      out.write("\t\t\t\t\t\t\t<input id=\"disabled_false_edit\" type=\"radio\" name=\"disabled\" checked=\"checked\" value=\"false\" />\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"disabled_false_edit\">不禁用</label></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div id=\"change_password_form_div\" style=\"display: none;\">\r\n");
      out.write("\t\t\t\t<form id=\"change_password_form\" action=\"");
      out.print(request.getContextPath());
      out.write("/admin/user/password_reset.ajax\"  method=\"post\">\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" style=\"display: none;\" name=\"id\" />\r\n");
      out.write("\t\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>新密码：</td><td>\r\n");
