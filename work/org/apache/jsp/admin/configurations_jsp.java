 ...
 * Generated at: 2012-10-15 13:10:16 UTC
...
public final class configurations_jsp extends org.apache.jasper.runtime.HttpJspBase
...
static {
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t$(function() {\r\n");
      out.write("\t\t\t\t\t\tt = new SimpleTable(\"configQueryTable\", {\r\n");
      out.write("\t\t\t\t\t\t\tpaging : false,\r\n");
      out.write("\t\t\t\t\t\t\tparam : 'searchDiv',\r\n");
      out.write("\t\t\t\t\t\t\turl : '");
      out.print(request.getContextPath());
      out.write("/core/config/query.html',\r\n");
      out.write("\t\t\t\t\t\t\tsortables : [\"key\"],\r\n");
      out.write("\t\t\t\t\t\t\t// checkMode : 'single',\r\n");
      out.write("\t\t\t\t\t\t\t// scrollX : true,\r\n");
      out.write("\t\t\t\t\t\t\tcolumns : {\r\n");
      out.write("\t\t\t\t\t\t\t\tkey : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\theader : '配置项',\r\n");
      out.write("\t\t\t\t\t\t\t\t\twidth : '36%'\r\n");
      out.write("\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\tvalue : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\theader : '值',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tajaxSubmitForm(\"config_add_form\", editCallback);\r\n");
      out.write("\t\t\t\t\t\t\t\t},\r\n");
      ...
      out.write("\t\t\t\t\t\tdoGetAjax(\"");
      out.print(request.getContextPath());
      out.write("/core/config/\" + id + \".html\", '', function(data, textStatus, XMLHttpRequest) {\r\n");
      out.write("\t\t\t\t\t\t\tfillForm(\"config_add_form\", data);\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#config_add_form_div\").dialog(\"open\");\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\tfunction doDel(id) {\r\n");
      out.write("\t\t\t\t\t\tshowConfirm(\"确认要删除选中的配置项吗？\", function() {\r\n");
      out.write("\t\t\t\t\t\t\tdoPostAjax(\"");
      out.print(request.getContextPath());
      out.write("/core/config/delete.html\", \"id=\" + id, function(resp) {\r\n");
      ...
      out.write("\t\t\t\t\t\t\tvar dialog = $('#config_add_form_div').dialog(\"open\");\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t</script>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div id=\"tableDiv\" style=\"width: 100%;\">\r\n");
      out.write("\t\t\t\t\t<table id=\"configQueryTable\"></table>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div id=\"config_add_form_div\" style=\"display: none;\">\r\n");
      out.write("\t\t\t\t<form id=\"config_add_form\" action=\"");
      out.print(request.getContextPath());
      out.write("/core/config/edit.html\"  method=\"post\">\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" style=\"display: none;\" name=\"id\" />\r\n");
      out.write("\t\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>配置项：</td><td>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"key\" size=\"34\" />\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>值：</td><td>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"value\" size=\"34\" />\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>是否禁用：</td><td>\r\n");
      out.write("\t\t\t\t\t\t\t<select name=\"disabled\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"false\">未禁用</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"true\">已禁用</option>\r\n");
      out.write("\t\t\t\t\t\t\t</select></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</form>\r\n");
