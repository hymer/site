 ...
 * Generated at: 2012-10-15 13:15:42 UTC
...
static {
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\tview : {\r\n");
      out.write("\t\t\t\t\t\t\taddHoverDom : addHoverDom, //生成添加按钮\r\n");
      out.write("\t\t\t\t\t\t\tremoveHoverDom : removeAddHoverDom, //删除添加按钮\r\n");
      ...
      out.write("\t\t\t\t\t\tif(treeNode.editNameFlag || $(\"#addBtn_\" + treeNode.id).length > 0)\r\n");
      out.write("\t\t\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t\t\tvar addStr = \"<span class='button add' id='addBtn_\" + treeNode.id + \"' title='add node' onfocus='this.blur();'></span>\";\r\n");
      out.write("\t\t\t\t\t\tsObj.after(addStr);\r\n");
      out.write("\t\t\t\t\t\tvar btn = $(\"#addBtn_\" + treeNode.id);\r\n");
      out.write("\t\t\t\t\t\tif(btn)\r\n");
      out.write("\t\t\t\t\t\t\tbtn.bind(\"click\", function() {\r\n");
      out.write("\t\t\t\t\t\t\t\tzTree.selectNode(treeNode);\r\n");
      out.write("\t\t\t\t\t\t\t\tadd(treeNode);\r\n");
      out.write("\t\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t};\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\tfunction removeAddHoverDom(treeId, treeNode) {\r\n");
      out.write("\t\t\t\t\t\t$(\"#addBtn_\" + treeNode.id).unbind().remove();\r\n");
      out.write("\t\t\t\t\t};\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\tfunction beforeEditName(treeId, treeNode) {\r\n");
      out.write("\t\t\t\t\t\tzTree.selectNode(treeNode);\r\n");
      out.write("\t\t\t\t\t\tedit(treeNode);\r\n");
      out.write("\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\tfunction beforeRemove(treeId, treeNode) {\r\n");
      out.write("\t\t\t\t\t\tzTree.selectNode(treeNode);\r\n");
      out.write("\t\t\t\t\t\tremove(treeNode);\r\n");
      out.write("\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t$(function() {\r\n");
      out.write("\t\t\t\t\t\t$('#config_add_form_div').dialog({\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tajaxSubmitForm(\"config_add_form\", function() {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvar nodes = zTree.getSelectedNodes();\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tzTree.reAsyncChildNodes(nodes[0], \"refresh\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t\t\t},\r\n");
      ...
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t$('#menu_edit_form_div').dialog({\r\n");
      out.write("\t\t\t\t\t\t\tdraggable : true,\r\n");
      out.write("\t\t\t\t\t\t\ttitle : '修改',\r\n");
      out.write("\t\t\t\t\t\t\twidth : 430,\r\n");
      out.write("\t\t\t\t\t\t\tmodal : true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\tbuttons : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\"OK\" : function() {\r\n");
      out.write("\t\t\t\t\t\t\t\t\tajaxSubmitForm(\"menu_edit_form\", function() {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvar nodes = zTree.getSelectedNodes();\n");
      out.write("\t\t\t\t\t\t\t\t\t\tzTree.reAsyncChildNodes(nodes[0].getParentNode(), \"refresh\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\"Cancel\" : function() {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t$(this).dialog(\"close\");\r\n");
      ...
      out.write("\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\tfunction add(parentNode) {\r\n");
      out.write("\t\t\t\t\t\tdocument.forms['config_add_form'].reset();\r\n");
      out.write("\t\t\t\t\t\tvar pid = parentNode.id;\r\n");
      out.write("\t\t\t\t\t\t$(\"#f_pid\").val(pid);\r\n");
      out.write("\t\t\t\t\t\t$('#config_add_form_div').dialog(\"open\");\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\tfunction edit(treeNode) {\r\n");
      out.write("\t\t\t\t\t\tdocument.forms['config_add_form'].reset();\r\n");
      out.write("\t\t\t\t\t\tvar editForm = $(\"#menu_edit_form\");\r\n");
      out.write("\t\t\t\t\t\t$(\"input[name=id]\", editForm).val(treeNode.id);\r\n");
      out.write("\t\t\t\t\t\tvar name = treeNode.name;\r\n");
      out.write("\t\t\t\t\t\tvar index = name.indexOf(\".\") + 1;\r\n");
      out.write("\t\t\t\t\t\t$(\"input[name=name]\", editForm).val(name.substring(index, name.length));\r\n");
      out.write("\t\t\t\t\t\t$(\"input[name=link]\", editForm).val(treeNode.link);\r\n");
      out.write("\t\t\t\t\t\t$(\"input[name=order]\", editForm).val(treeNode.order);\r\n");
      out.write("\t\t\t\t\t\t$('#menu_edit_form_div').dialog(\"open\");\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\tfunction remove(treeNode) {\r\n");
      out.write("\t\t\t\t\t\tvar id = treeNode.id;\r\n");
      out.write("\t\t\t\t\t\tshowConfirm(\"确认要删除选中的菜单吗？\", function() {\r\n");
      out.write("\t\t\t\t\t\t\tdoPostAjax(\"");
      out.print(request.getContextPath());
      out.write("/menu/delete.html\", \"id=\" + id, function(resp) {\r\n");
      out.write("\t\t\t\t\t\t\t\tshowMsg(resp);\r\n");
      out.write("\t\t\t\t\t\t\t\tzTree.reAsyncChildNodes(treeNode.getParentNode(), \"refresh\");\r\n");
      out.write("\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t</script>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div id=\"config_add_form_div\" style=\"display: none;\">\r\n");
      out.write("\t\t\t<form id=\"config_add_form\" action=\"");
      out.print(request.getContextPath());
      out.write("/menu/addsubmenu.ajax\"  method=\"post\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" style=\"display: none;\" id=\"f_pid\" name=\"pid\" />\r\n");
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>名称：</td><td>\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"name\" size=\"34\" />\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>链接：</td><td>\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"link\" size=\"34\" />\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>排序：</td><td>\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"order\" size=\"8\" />\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div id=\"menu_edit_form_div\" style=\"display: none;\">\r\n");
      out.write("\t\t\t<form id=\"menu_edit_form\" action=\"");
      out.print(request.getContextPath());
      out.write("/menu/editmenu.ajax\"  method=\"post\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" style=\"display: none;\" id=\"f_id\" name=\"id\" />\r\n");
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>名称：</td><td>\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"name\" size=\"34\" />\r\n");
