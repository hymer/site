 ...
 * Generated at: 2012-12-28 12:01:40 UTC
...
public final class finacing_005fpurchase_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t$(function() {\r\n");
      out.write("\t\t\t\t\t\tt = new SimpleTable(\"finacingQueryTable\", {\r\n");
      out.write("\t\t\t\t\t\t\tparam : 'searchDiv',\r\n");
      out.write("\t\t\t\t\t\t\turl : '");
      out.print(request.getContextPath());
      out.write("/finacing/query.html',\r\n");
      out.write("\t\t\t\t\t\t\tsortables : [\"id\"],\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\twidth : '39%'\r\n");
      out.write("\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\tcontractAmount : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\theader : '总金额',\r\n");
      out.write("\t\t\t\t\t\t\t\t\twidth : '15%'\r\n");
      out.write("\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\tpaidAmount : {\n");
      out.write("\t\t\t\t\t\t\t\t\theader : '已付款',\n");
      out.write("\t\t\t\t\t\t\t\t\twidth : '15%'\n");
      out.write("\t\t\t\t\t\t\t\t},\n");
      out.write("\t\t\t\t\t\t\t\tnotPaidAmount : {\n");
      out.write("\t\t\t\t\t\t\t\t\theader : '未付款',\n");
      out.write("\t\t\t\t\t\t\t\t\twidth : '15%'\n");
      out.write("\t\t\t\t\t\t\t\t},\n");
      out.write("\t\t\t\t\t\t\t\tops : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\theader : '操作',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tpaidAmount : function(v, obj) {\r\n");
      out.write("\t\t\t\t\t\t\t\t\treturn '<font color=\"green\">' + v + '</font>';\r\n");
      out.write("\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\tnotPaidAmount : function(v, obj) {\r\n");
      out.write("\t\t\t\t\t\t\t\t\treturn '<font color=\"red\">' + (obj.contractAmount - obj.paidAmount) + '</font>';\r\n");
      out.write("\t\t\t\t\t\t\t\t\t;\r\n");
      out.write("\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\tops : function(v, obj) {\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar html = '';\r\n");
      out.write("\t\t\t\t\t\t\t\t\thtml += \"<a target='_blank' href='finacing/manager/\" + obj.id + \".html'>管理</a>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\thtml += \"&nbsp;&nbsp;<a href='javascript:removeFinancing(\" + obj.id + \");'>删除</a>\";\r\n");
      ...
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t$('#finacing_add_form_div').dialog({\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tajaxSubmitForm(\"finacing_add_form\", editCallback);\r\n");
      out.write("\t\t\t\t\t\t\t\t},\r\n");
      ...
      out.write("\t\t\t\t\t\tdoGetAjax(\"");
      out.print(request.getContextPath());
      out.write("/finacing/\" + id + \".html\", '', function(data, textStatus, XMLHttpRequest) {\r\n");
      out.write("\t\t\t\t\t\t\tfillForm(\"finacing_add_form\", data);\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#finacing_add_form_div\").dialog(\"open\");\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t</script>\r\n");
      out.write("\t\t\t\t<div id=\"searchDiv\" style=\"width: 90%;\">\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" style=\"display: none;\" name=\"finacingType\" value=\"purchase\" />\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<!--\r\n");
      out.write("\t\t\t\t\t\t\t<td>是否已付清：\r\n");
      out.write("\t\t\t\t\t\t\t<select name=\"paidAll\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"\">全部</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"Y\">已付清</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"N\" selected=\"selected\">未付清</option>\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t-->\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\tt.doSearch();\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\tfunction removeFinancing(id) {\r\n");
      out.write("\t\t\t\t\t\t\tshowConfirm(\"确认要删除选中的财务信息吗？\", function() {\r\n");
      out.write("\t\t\t\t\t\t\t\tdoPostAjax(\"");
      out.print(request.getContextPath());
      out.write("/finacing/delete.html\", \"id=\" + id, function(resp) {\r\n");
      ...
      out.write("\t\t\t\t\t<table id=\"finacingQueryTable\"></table>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t");
      out.write("\r\n");
