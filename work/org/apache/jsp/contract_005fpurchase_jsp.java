 ...
 * Generated at: 2012-10-18 11:58:23 UTC
...
public final class contract_005fpurchase_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\turl : '");
      out.print(request.getContextPath());
      out.write("/contract/query.html',\r\n");
      out.write("\t\t\t\t\t\t\tsortables : [\"contractName\", \"id\"],\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\twidth : '28%'\r\n");
      out.write("\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\tsupplierLinkman : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\theader : '联系人',\r\n");
      out.write("\t\t\t\t\t\t\t\t\twidth : '15%'\r\n");
      out.write("\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\tsignDate : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\theader : '签订时间',\r\n");
      out.write("\t\t\t\t\t\t\t\t\twidth : '9%'\r\n");
      out.write("\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t// status : {\n");
      out.write("\t\t\t\t\t\t\t\t// header : '状态',\n");
      ...
      out.write("\t\t\t\t\t\t\t\tid : function(v, obj) {\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar date = obj.signDate;\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar year = date.substring(0,4);\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar month = date.substring(5,7);\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar day = date.substring(8,10);\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar oo = v < 10 ? \"0\" : \"\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\treturn year + month + day + oo + v;\r\n");
      out.write("\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\tops : function(v, obj) {\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar html = '';\r\n");
      out.write("\t\t\t\t\t\t\t\t\thtml += \"<a target='_blank' href='contract/view/\" + obj.id + \".html'>查看</a>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\thtml += \"&nbsp;&nbsp;<a target='_blank' href='contract/edit/\" + obj.id + \".html'>修改</a>\";\r\n");
      ...
      out.write("\t\t\t\t\t<input type=\"text\" name=\"contractType\" style=\"display: none;\" value=\"purchase\" />\r\n");
      out.write("\t\t\t\t\t<table width=\"100%\">\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"20%\">供应商名称：</td><td width=\"30%\">\r\n");
      out.write("\t\t\t\t\t\t\t<input name=\"supplierName\" />\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"20%\">联系人：</td><td width=\"30%\">\r\n");
      out.write("\t\t\t\t\t\t\t<input name=\"supplierLinkman\" />\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tshowConfirm(\"确认要删除选中的合同吗？\", function() {\r\n");
      out.write("\t\t\t\t\t\t\t\t\tdoPostAjax(\"");
      out.print(request.getContextPath());
      out.write("/contract/delete.html\", \"ids=\" + rids, function(resp) {\r\n");
      ...
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t</script>\r\n");
      out.write("\t\t\t\t\t<a href=\"contract_purchase_add.jsp\" target=\"_blank\">添加新合同</a>\r\n");
      out.write("\t\t\t\t\t&nbsp;&nbsp; <a href=\"javascript:removeResources();\">删除选中合同</a>\r\n");
      out.write("\t\t\t\t\t<br />\r\n");
      out.write("\t\t\t\t\t<br/>\r\n");
      out.write("\t\t\t\t</div>\r\n");
