 ...
 * Generated at: 2012-10-21 08:43:53 UTC
...
public final class item_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t$(function() {\r\n");
      out.write("\t\t\t\t\t\tt = new SimpleTable(\"itemQueryTable\", {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t$('#item_add_form_div').dialog({\r\n");
      out.write("\t\t\t\t\t\t\tdraggable : true,\r\n");
      out.write("\t\t\t\t\t\t\ttitle : '添加/修改产品/物料',\r\n");
      out.write("\t\t\t\t\t\t\twidth : 620,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tajaxSubmitForm(\"item_add_form\", editCallback);\r\n");
      out.write("\t\t\t\t\t\t\t\t},\r\n");
      ...
      out.write("\t\t\t\t\t\tdoGetAjax(\"");
      out.print(request.getContextPath());
      out.write("/item/\" + id + \".html\", '', function(data, textStatus, XMLHttpRequest) {\r\n");
      out.write("\t\t\t\t\t\t\tfillForm(\"item_add_form\", data);\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#item_add_form_div\").dialog(\"open\");\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t</script>\r\n");
      ...
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"20%\">产品编码：</td><td width=\"30%\">\r\n");
      out.write("\t\t\t\t\t\t\t<input name=\"itemCode\" />\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"20%\">产品名称：</td><td width=\"30%\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\tdocument.forms['item_add_form'].reset();\r\n");
      out.write("\t\t\t\t\t\t\tvar dialog = $('#item_add_form_div').dialog(\"open\");\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\tfunction removeItems() {\r\n");
      out.write("\t\t\t\t\t\t\tvar rids = t.getSelected();\r\n");
      out.write("\t\t\t\t\t\t\tif(rids.length >= 1) {\r\n");
      out.write("\t\t\t\t\t\t\t\tshowConfirm(\"确认要删除选中的产品/物料吗？\", function() {\r\n");
      out.write("\t\t\t\t\t\t\t\t\tdoPostAjax(\"");
      out.print(request.getContextPath());
      out.write("/item/delete.html\", \"ids=\" + rids, function(resp) {\r\n");
      ...
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t</script>\r\n");
      out.write("\t\t\t\t\t<a href=\"javascript:showAddForm();\">添加新产品/物料</a>\r\n");
      out.write("\t\t\t\t\t&nbsp;&nbsp; <a href=\"javascript:removeItems();\">删除选中产品/物料</a>\r\n");
      out.write("\t\t\t\t\t<br />\r\n");
      out.write("\t\t\t\t\t<br/>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div id=\"tableDiv\" style=\"width: 100%;\">\r\n");
      out.write("\t\t\t\t\t<table id=\"itemQueryTable\"></table>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div id=\"item_add_form_div\" style=\"display: none;\">\r\n");
      out.write("\t\t\t\t<form id=\"item_add_form\" action=\"");
      out.print(request.getContextPath());
      out.write("/item/edit.html\"  method=\"post\">\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" style=\"display: none;\" name=\"id\" />\r\n");
      out.write("\t\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>产品编码：</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"itemCode\" />\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<td>规格：</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"itemStandard\" />\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>单位：</td><td>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"itemUnit\" />\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>单价：</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>备注：</td><td>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"itemRemark\" />\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</form>\r\n");
